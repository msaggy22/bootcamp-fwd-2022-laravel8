    ...
    <div class="navbar-wrapper">
        ...
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item"><a class="navbar-brand" href="{{ url('backsite.dashboard.index') }}"><img class="brand-logo" alt="modern admin logo" src="{{ asset('/assets/backsite/app-assets/images/logo/logo.png') }}">
